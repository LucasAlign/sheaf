...
export function checkOrigin(origin: string | undefined, appUrl: string) { if (!origin || origin !== new URL(appUrl).origin) throw new HttpError(403,'Please submit this request from your Sheaf portal.'); }
