...
The default screen is the caseworker dashboard: Overview, Needs pipeline, and Email outreach. The footer opens the volunteer community feed. Live mode requires staff sign-in before the admin workspace becomes accessible.
...
- Staged outreach: 3 matches initially, then 6, 9, etc., with each incremental wave capped at 30. Urgent widens after 15 minutes, soon after 4 hours, flexible after 24 hours. A claimed need stops subsequent match outreach.
