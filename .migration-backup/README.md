...
An admin-first needs and volunteer outreach portal for **Keystone Family Alliance**, serving Pennsylvania. Authorized staff publish needs directly, Bridge selects volunteers in small waves, and volunteers claim through secure email links. The public feed is a secondary route at `/?view=feed`.
...
- Authorized caseworkers, county coordinators, assistants, and admins publish needs and photos directly; there is no second content-verification queue.
...
- Public town/meeting-point location and posting identity on needs, plus private-storage photo attachments that publish immediately after upload validation.
